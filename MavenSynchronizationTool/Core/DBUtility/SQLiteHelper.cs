...
{
    /// <summary>
    /// SQLiteHelper is a utility class similar to "SQLHelper" is MS
    ...
    public class SQLiteHelper
    {
        ...
        /// <summary>
        /// Shortcut method to execute dataset from SQL Statement and object[] array of parameter values
        /// </summary>
        ...
        /// Shortcut method to execute dataset from SQL Statement and object[] array of parameter values
        /// </summary>
        /// <param name="conn">Conneciton</param>
        /// <param name="commandText">Command Text</param>
        /// <param name="paramList">Param List</param>
        /// <returns>DataSet</returns>
        public static DataSet ExecuteDataSet(SQLiteConnection conn, string commandText, object[] paramList)
        {
            SQLiteCommand cmd = conn.CreateCommand();
        ...
        /// </summary>
        /// <param name="transaction">SQLiteTransaction.Transaction consists of Connection, Transation,/// and Command, all of which must be created prior to making this method call</param>
        /// <param name="commandText">Command text</param>
        ...
        {
            if (cmd.Connection == null) throw new ArgumentException("Command must have live connection attached.", "cmd");
            cmd.CommandText = commandText;
            AttachParameters(cmd, commandText, paramList);
            if(cmd.Connection.State == ConnectionState.Closed)
            {
        ...
        public static int ExecuteNonQuery(SQLiteConnection conn, string commandText, params object[] paramList)
        {
            SQLiteCommand cmd = conn.CreateCommand();
            cmd.CommandText = commandText;
            AttachParameters(cmd, commandText, paramList);
        ...
        protected internal static void AssignParameterValues(IDataParameterCollection commandParameters, DataRow dataRow)
        {
            ...
            foreach(IDataParameter commandParameter in commandParameters)
            {
                ...
                {
                    throw new InvalidOperationException(string.Format("Please provide a valid parameter name on the parameter #{0}, the Parameter property has the following value:'{1}'.",
